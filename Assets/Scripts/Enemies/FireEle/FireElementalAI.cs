...
public class FireElementalAI : MonoBehaviour
{
	private EnemyFireElemental enemyFireEle;
	...
	public float maxDistanceToPlayer = 0.2f; // How close to player can enemy walk.
	...
	void Start()
	{
		enemyFireEle = GetComponent<EnemyFireElemental>();
	...
	void FixedUpdate()
	{
		...
		if ((currentDistanceToPlayer < 1.8f) && (isAttacking == false))
		{
			isAttacking = true;
			enemyFireEle.BlowUp();
		} 
